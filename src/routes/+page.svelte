...
<div class="w-full h-full font-mono text-gray-500 bg-[#050505] min-h-screen text-sm -m-4">
    <div class="max-w-[1400px] mx-auto p-4 md:p-8 flex flex-col gap-12 pt-8">
        ...
        <div class="mt-8 space-y-6">
            ...
            <a href="https://github.com/roymercenteno7/notracer" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-gray-600 hover:text-neon transition-colors mt-2">
